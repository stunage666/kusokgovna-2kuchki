...
<div class="page-wrap">
   ...
   <div class="navbar navbar-default navbar-fixed-top" role="navigation">
                    ...
                    <ul id="login-dp" class="dropdown-menu">
                        <li>
                            <div class="row">
								...
								<?php if ($_SESSION['id'] != '')
								{	
									echo '<form class="form" role="form"  action="reg1.php" method="post" id="login-nav">
    ...
    <form action="php/userload.php" class="rf" method="post"> 
    <div class="row ">
            ...
            <div class="container formm ordder">
                 ...
                 <div class="input-group ordder ">
                         <span class="input-group-addon AdmSpan">Поиск:</span>
                             <input type="text" id="name" class="form-control rfield" name="Name"  placeholder="Жанна">
        ...
        <ul class="dropdown-menu pull-right">
         <li>
          <form class="form" role="form" action="index.php" method="post" id="login-nav">
        ...
        <tbody>
		  ...
		  {	
            ...
            <td id="number">'.$_SESSION[$idn].'</td>
			  ...
			  <td><div id="ClearFormL" class="AdmPanel well" name="Email1">sexyboy93@bk.ru</div></td>
...
?> 
                ...
                <div class="input-group ordder ">
                         <span class="input-group-addon AdmSpan">Поиск по ID:</span>
                             <input type="text" id="name" class="form-control rfield" name="Name"  placeholder="12345">
                          <div class="input-group-btn">
  ...
  <div class="scroll-table OneSearch">
    <table class="table">
        <tbody>
          ...
          <tr id="FormClient">
            <td id="number">1</td>
              <td><input type="text" id="ClearFormF" class="form-control AdmUpdate" name="FName1"  placeholder="Иван"></td>
            <td><input type="text" id="ClearFormL" class="form-control AdmUpdate" name="LName1"  placeholder="Иванов"></td>
            <td><input type="text" id="ClearFormL" class="form-control AdmUpdate" name="LName1"  placeholder="Иванов"></td>
            <td><input type="text" id="ClearFormL" class="form-control AdmUpdate" name="LName1"  placeholder="Иванов"></td>
            <td><input type="text" id="ClearFormL" class="form-control AdmUpdate" name="LName1"  placeholder="Иванов"></td>
            <td><input type="text" id="ClearFormL" class="form-control AdmUpdate" name="LName1"  placeholder="Иванов"></td>
